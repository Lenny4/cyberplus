...
<div class="payment-content" id="myForm">
	...
	<table id="payment-table">
		...
		<tr>
			...
			<td class="payment-row-right"><strong><?php echo price($totalObject); ?> <?php echo $currency; ?>
					TTC</strong></td>
		</tr>
		<tr>
			<td class="payment-row-left"><?php echo $langs->trans('AmountAlreadyPaid'); ?> :</td>
			<td class="payment-row-right"><strong><?php echo price($alreadyPaid); ?> <?php echo $currency; ?>
					TTC</strong></td>
		</tr>
		<tr>
			<td class="payment-row-left"><?php echo $langs->trans('AmountToPay'); ?> :</td>
			<td class="payment-row-right"><strong><?php echo price($amountTransaction); ?> <?php echo $currency; ?>
					TTC</strong></td>
		</tr>
		<tr class="liste_total">
			<td colspan="2" class="payment-button">
				<form action="<?php echo $urlServer; ?>" method="post" id="PaymentRequest" target=iframe>
					...
					<input class="button" type="submit" value="<?php echo $langs->trans('Continue'); ?>"
						   onclick="openForm()"/>
				</form>
			</td>
		</tr>
