...
<div id="btn">
    ...
    <table id="payment-table">
            ...
            <tr>
                ...
                <td class="payment-row-right" colspan="2"><strong><?php echo price($totalObject); ?> <?php echo $currency; ?> TTC</strong></td>
            </tr>
            <tr>
                <td class="payment-row-left"><?php echo ($langs->trans('AmountAlreadyPaid'));?> :</td>
                <td class="payment-row-right" colspan="2"><strong><?php echo price($alreadyPaid); ?> <?php echo $currency; ?> TTC</strong></td>
            </tr>
            <tr>
                <td class="payment-row-left"><?php echo $langs->trans('AmountToPay');?> :</td>
                <td class="payment-row-right" colspan="2"><strong><?php echo price($amountTransaction); ?> <?php echo $currency; ?> TTC</strong></td>             
            <tr class="liste_total">
                ...
                <td colspan="2" class="payment-button_2">
                    ...
                    <input class="cb_2" type="image" id="button_2"  src="<?php echo 'img/Logo_CB_'. $count .'.png'?>" value="Payer" onclick="openForm()"/>
                    </form>
                </td>
            </tr>
    </table>
