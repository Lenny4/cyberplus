 ...
 */
class pdf_GIDM_cyberplus extends ModelePDFFactures
{
	var $db;
	var $name;
	var $description;
			...
			if (file_exists($dir)) {
				...
				if ($conf->incoterm->enabled) {
					...
					if ($desc_incoterms) {
						...
						//$pdf->RoundedRect($this->marge_gauche, $tab_top-1, $this->page_largeur-$this->marge_gauche-$this->marge_droite, $height_incoterms+1,1.2,'1111'); //modification GIDM
				...
				if ($notetoshow) {
					...
					// Rect prend une longueur en 3eme param
					$pdf->SetDrawColor(192, 192, 192);
					$pdf->RoundedRect($this->marge_gauche, $tab_top - 1, $this->page_largeur - $this->marge_gauche - $this->marge_droite, $height_note + 1, 1.2, '1111');//modification GIDM
				...
				for ($i = 0; $i < $nblignes; $i++) {
					...
					if (!empty($conf->global->MAIN_PDF_DASH_BETWEEN_LINES) && $i < ($nblignes - 1)) {
						...
						//$pdf->line($this->marge_gauche, $nexY+1, $this->page_largeur - $this->marge_droite, $nexY+1); //modification GIDM
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		if ($showaddress) {
			...
			$pdf->RoundedRect($posx, $posy, $widthrecbox, $hautcadre, 1.2, '1111', 'DF', array('width' => 0.1, 'cap' => '', 'join' => '', 'dash' => '', 'color' => array(230, 230, 230))); //modification GIDM
			$pdf->SetTextColor(0, 0, 60);
			...
			$pdf->RoundedRect($posx, $posy, $widthrecbox, $hautcadre, 1.2, '1111'); //modification GIDM
	...
	function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs, $hidetop = 0, $hidebottom = 0, $currency = '')
	{
		...
		$pdf->roundedRect($this->marge_gauche, $tab_top, $this->page_largeur - $this->marge_gauche - $this->marge_droite, $tab_height, 1.2, '1111'); //modification GIDM
